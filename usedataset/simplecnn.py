...
from MusicDataset import Musicdata_v9
...
train_set = Musicdata_v9(data_file=data_file, label_file=label_file, start=0, total=2560)
test_set = Musicdata_v9(data_file=data_file, label_file=label_file, start=2560, total=3219)
