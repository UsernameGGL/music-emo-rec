...
for line in reader_list:
	if line == []:
		continue
	if create_labels:
		input_labels = [list(map(int, line))]
		create_labels = False
	else:
		input_labels.append(list(map(int, line)))
	if len(input_labels) == input_num:
		break
